...
#define LTTNG_UST_TRACEPOINT_INCLUDE "./python_lttng_ust_tracepoint.h"

#if !defined(_PYTHON_LTTNG_UST_TRACEPOINT_H_) || defined(LTTNG_UST_TRACEPOINT_HEADER_MULTI_READ)
#define _PYTHON_LTTNG_UST_TRACEPOINT_H_
...
#endif /* _PYTHON_LTTNG_UST_TRACEPOINT_H_ */
