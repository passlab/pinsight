...
#define TRACEPOINT_INCLUDE_FILE ./cupti_lttng_tracepoint.h

#if !defined(CUPTI_LTTNG_TRACEPOINT_H) || defined(TRACEPOINT_HEADER_MULTI_READ)
#define CUPTI_LTTNG_TRACEPOINT_H
...
#ifndef CUPTI_LTTNG_TRACEPOINT_H_DECLARE_ONCE
#define CUPTI_LTTNG_TRACEPOINT_H_DECLARE_ONCE
#ifdef PINSIGHT_MPI
extern int mpirank ;
#endif
...
#endif /* CUPTI_LTTNG_TRACEPOINT_H */
